...
import {broadleaf,cherryBlossom} from "../src/botanical-organs.ts";

test("botanical organs are folded meshes with attached petioles and finite normals",()=>{
  for(const kind of ["birch","maple","cherry","fern","blossom"]) {
    const g=kind==="blossom"?cherryBlossom():broadleaf(kind);
